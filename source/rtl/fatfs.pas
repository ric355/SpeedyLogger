...
// RM TEMPORARILY REMOVED THIS TO ADDRESS DISK SPACE PROBLEM
//         Exit;
        end;
      finally
       SectorUnlock;
...
begin
 ...
 try
  ...
  //RM this is temporary to test if it works (only if we do a dismount command).
  //SetFreeClusterCount(FFreeClusterCount);
